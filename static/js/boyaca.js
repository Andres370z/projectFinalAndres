...
function createChart(dataObject) {
  ...
  // Crea el elemento img
  var imagen = document.createElement("img");
  imagen.src = dataObject.data[6].image.source.url;
  imagen.alt = "Descripción de la imagen";
  imagen.className = "img-fluid rounded mx-auto d-block";

  var figcaption = document.createElement("figcaption");
  figcaption.textContent = "Por: " + dataObject.data[53].author.name;
  ...
  // Crea el elemento img
  var imagen = document.createElement("img");
  imagen.src = 'https://cdn.baquianos.com/img/blog/2020/27/cocuy-skm.jpg';
  imagen.alt = "Descripción de la imagen";
  imagen.className = "img-fluid rounded mx-auto d-block";
